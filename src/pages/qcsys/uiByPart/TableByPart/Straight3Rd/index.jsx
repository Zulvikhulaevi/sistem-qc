...
const Straight3RdData = () => {
  const { allData, isModalDetailOpen, isModalDeleteOpen } =
    useAllStateContext();
  const { getDataById } = useDataFunctionContext();

  return (
    <div className="min-h-96 max-h-96 min-w-full px-2 overflow-x-auto overflow-y-auto">
